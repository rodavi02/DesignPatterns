...
<body id="page-top">
  ...
  <header class="masthead bg-primary text-white text-center">
    <h4 class="masthead-heading mb-4">Diseño de pantalones</h4>
    <div class="container d-flex align-items-center flex-column">
      <form method="POST" enctype="multipart/form-data" action="pantalones.php">
        <div class="form-row">
  ...
  if (isset($_POST["crear"])) {
    Pantalon::nuevoProductoPantalon(); 
  }
  if (isset($_POST["crear"])) {
    if ($_POST["estilo"]=="corto") {
      EstiloCorto::clonEstiloCorto();
    } elseif ($_POST["estilo"]=="largo") {
          EstiloLargo::clonEstiloLargo();
      } else {
